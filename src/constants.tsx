...
export const MUSIC_URL =
  ...
  "https://cs1.mp3.pm/download/1088606/cmxhU2dFaWI2YzU2ZXowOTFRRjN1QXJrcCtFdnBRMmdJeCtLdUgxc25CUDZ4QjRoMlF2QTZkb2VoYVNxMHhqNGdqQkgyT2lzbzh3UmQ2aXBqMUFzN0tuZzd1SlRybTlMT0IvanArMVVsMW5YQ2loM0tmdGlzNUY0Z1h6RGEwelY/M_-_Indila_-Love_Story_Version_Orchestrale_(mp3.pm).mp3";
...
export const WEDDING_TEXT = {
  ...
  closing: {
    ...
    family: "Kel. Bpk Mohammad Arief Wicaksono S.H. & Kel. Bpk Anang Barmawi",
  },
...
export const WEDDING_CONFIG: WeddingConfig = {
  couple: {
    bride: {
      name: import.meta.env.PUBLIC_BRIDE_NICKNAME ?? "Putri",
      fullName: import.meta.env.PUBLIC_BRIDE_FULLNAME ?? "Nandyar Astari Putri S.H.",
      parents:
    ...
    groom: {
      name: import.meta.env.PUBLIC_GROOM_NICKNAME ?? "Hifni",
      fullName: import.meta.env.PUBLIC_GROOM_FULLNAME ?? "Mohammad Hifni Iskandar Shah S.H.",
      parents:
  ...
  venue: {
    name: import.meta.env.PUBLIC_VENUE_NAME ?? "The Gade Village Balkondes Ngargogondo",
  ...
  events: {
    akad: {
      ...
      loc: import.meta.env.PUBLIC_AKAD_LOC ?? "Gedung Tea Desa Treko Kec. Mungkid Kab. Magelang",
    ...
    resepsi: {
      ...
      loc: import.meta.env.PUBLIC_RESEPSI_LOC ?? "Gedung Tea Desa Treko Kec. Mungkid Kab. Magelang",
      startDateTime: new Date(
    ...
    ngunduh: {
      title: import.meta.env.PUBLIC_NGUNDUH_TITLE ?? "Perayaan Cinta",
      day: import.meta.env.PUBLIC_NGUNDUH_DAY ?? "Minggu",
      date: import.meta.env.PUBLIC_NGUNDUH_DATE ?? "17 Oktober 2025",
      loc: import.meta.env.PUBLIC_NGUNDUG_LOC?? "",
      startTime: import.meta.env.PUBLIC_NGUNDUH_START ?? "11:00",
      endTime: import.meta.env.PUBLIC_NGUNDUH_END ?? "14:00",
      startDateTime: new Date(
        import.meta.env.PUBLIC_NGUNDUH_ISO_START ?? "2026-01-17T11:00:00+07:00"
      ),
      endDateTime: new Date(
        import.meta.env.PUBLIC_NGUNDUH_ISO_END ?? "2025-10-11T14:00:00+07:00"
      ),
    },
  },
  hero: {
    ...
    city: import.meta.env.PUBLIC_HERO_CITY ?? "Kec. Borobudur, Kabupaten Magelang",
  },
};
